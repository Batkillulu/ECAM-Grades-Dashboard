...
(function() {
	...
	class ECAMDash {
		...
		//#region _______ — General methods — ________
			...
			//#region — Dashboard methods
				...
				// MARK: toggleEditMode()
				/** Toggles between the edit mode of this ECAMDash being enabled or not.  
				...
				// MARK: toggleViewMode()
				/** Toggles between the view mode of this ECAMDash being detailed or compact.  
				 * Performs all the actions related to the view mode being changed
				 * 
				 * @returns The view mode of this ECAMDash after being changed
				 */
				toggleViewMode() {
					const unclassifiedSection = document.querySelector(".unclassified-section");
	...
	class TutoTipNotif {
		 ...
		 * @param { ( board: ECAMDash ) => {} } [optionalData.initialAction=() => {}]
		 * @param { ( board: ECAMDash ) => {} } [optionalData.actionCallback=() => {this.dismissTipNotifDiv(); this.ecamDash.nextTipNotif();}]
		 * @param { ( board: ECAMDash ) => {} } [optionalData.additionalActionCallback=() => {}]
		 ...
		 * @param { ( board: ECAMDash ) => {} } optionalData.buttonsContainer.buttons.initialAction
		 * @param { ( board: ECAMDash ) => {} } optionalData.buttonsContainer.buttons.actionCallback
		 * @param { ( board: ECAMDash ) => {} } optionalData.buttonsContainer.buttons.additionalActionCallback
		 */
